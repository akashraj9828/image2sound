...
class b {
    ...
    public static void main(String[] args) {
        // print("" + wav2.map(0.5, 0, 1, 0, 100));
        wav2 obj = new wav2("out.wav");
        // obj.generate();
        obj.fillData();
        // ar[0][1] = 3;
...
class wav2 {
    ...
    public static int minFreq = 15000, maxFreq = 16000;

    // image related
    public static String imgFileName = "temp.png";
    public static int pixelpersecond = 1;

    public wav2(String a) {
        fileName = a;
    ...
    public static void fill(double ar[][], int width, int height, int seconds) {
        ...
        try {
            ...
            // for (short z : wav2.RawData)
            // { print(z);
                
            // }

            print("total samples:: " + index);
            print("expected samples:: " + SampleRate * wav2.seconds/pixelpersecond);
